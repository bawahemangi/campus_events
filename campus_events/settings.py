...
# Email settings (configure with real credentials)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-email@gmail.com'          # Change this
EMAIL_HOST_PASSWORD = 'your-app-password'          # Change this (use App Password)
DEFAULT_FROM_EMAIL = 'Campus Events <your-email@gmail.com>'

# For development/demo without real email - use console backend
